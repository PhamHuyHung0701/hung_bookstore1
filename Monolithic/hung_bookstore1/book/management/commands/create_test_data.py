...
class Command(BaseCommand):
    help = 'Create test data for the Monolithic project'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Created {len(staff_list)} staff members'))
        ...
        for _ in range(20):
            ...
            try:
                ...
                pass
        self.stdout.write(self.style.SUCCESS(f'Created {ratings_count} ratings'))
        ...
        for customer in customers:
            ...
            for _ in range(num_items):
                ...
                cart_items_count += 1
        self.stdout.write(self.style.SUCCESS(f'Created carts and {cart_items_count} cart items'))
        ...
        for customer in customers:
            ...
            for _ in range(num_items):
                ...
                order_items_count += 1
        self.stdout.write(self.style.SUCCESS(f'Created orders and {order_items_count} order items'))
        ...
        self.stdout.write(self.style.SUCCESS(f'Created {len(shipping_data)} shipping methods'))
        ...
        self.stdout.write(self.style.SUCCESS(f'Created {len(payment_data)} payment methods'))
