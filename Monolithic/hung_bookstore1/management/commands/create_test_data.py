...
from hung_bookstore1.book.models import Book, Rating, Staff
from hung_bookstore1.customer.models import Customer
from hung_bookstore1.cart.models import Cart, CartItem, Order, OrderItem, Shipping, Payment
import random

class Command(BaseCommand):
    help = 'Create test data for the database'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Sample data added to Monolithic database.'))
